                        ...
                        <?php $__currentLoopData = $fasilitasHotel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-6 d-flex align-items-stretch">
                                <div class="card" data-aos="fade-up" data-aos-delay="100">
                                    <img src="<?php echo e(asset('storage/' . $row->image)); ?>"
                                        alt=" <?php echo e($row->nama_fasilitas); ?> " style="border-radius: 5px;">
                                    <div class="card-body">
                                        <h5 class="card-title"><a> <?php echo e($row->nama_fasilitas); ?> </a></h5>
                                        <p class="card-text"> <?php echo e($row->keterangan); ?> </p>
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH D:\hotel-hebat-Boni\resources\views/about.blade.php ENDPATH**/ ?>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-4">
                        <div class="de-room">
                            <div class="d-image">
                                <a href="/details">
                                    <img src="<?php echo e(asset('storage/' . $row->image)); ?>" class="img-fluid" alt="">
                                </a>
                            </div>
                            <div class="d-text">
                                <h3><?php echo e($row->tipe_kamar); ?></h3>
                                <p>
...
<?php /**PATH D:\hotel-hebat-Boni\resources\views/rooms.blade.php ENDPATH**/ ?>
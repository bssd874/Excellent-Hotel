                    ...
                    <ul class="navbar-nav w-100">
                        <li class="nav-item w-100">
                            <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search" action="/dataReservasi/search" method="GET">
                                <input type="search" name="cari" class="form-control" placeholder="Cari nama tamu ..." autofocus value="<?php echo e(old('cari')); ?>">
...
</html><?php /**PATH D:\hotel-hebat-Boni\resources\views/resepsionis/layout.blade.php ENDPATH**/ ?>
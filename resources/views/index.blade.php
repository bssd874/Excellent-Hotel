...
<html lang="zxx">
    ...
    <body class="has-menu-bar">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="pt80 pb80">
                                <div class="mo-nav text-center">
                                    <a href="/home">
                                        <img class="logo" src="images/Hotel_Hebat__1_-removebg-preview.png" alt="">
                                    </a>
        ...
        <div id="content" class="no-bottom no-top">
            ...
            <section class="no-top no-bottom jarallax vertical-center" data-video-src="mp4:video/local-video.mp4">
                <div class="de-overlay v-center t5">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 offset-lg-3 text-center">
                                <h1>Excellent Hotel</h1>
                                <p class="lead">Cari hotel atau penginapan di Excellent Hotel yuk! Booking hotel mudah, murah, dan banyak pilihannya
                        hanya di Excellent Hotel.</p>
                                <a class="btn-main" href="/pesanReservasi"><span>Pesan</span></a>
                            </div>
                        </div>
                    </div>
                </div>

            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="post" action="{{ route('fasilitasKamar.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="description" id="description" placeholder="Masukan deskripsi" value="{{ old('description') }}">
                                @error('fasilitas')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
